...
-- 2024-08-12,TDryden,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_TDryden')
	 Begin 
	  Alter Database Assignment07DB_TDryden set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_TDryden;
	 End
	Create Database Assignment07DB_TDryden;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_TDryden;
